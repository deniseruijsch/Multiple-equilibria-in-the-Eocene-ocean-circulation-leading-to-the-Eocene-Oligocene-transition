...
class GlobalFourDegreeSetup(VerosSetup):
    ...
    def _read_forcing2(self, vs, var1):
        with h5netcdf.File('600_year_salinity_flux.nc', 'r') as infile:
    ...
    def set_forcing(self, vs):
        ...
        # prescribed surface salinity flux
    ...
    def set_diagnostics(self, vs):
        ...
        average_vars = ['temp', 'salt', 'u', 'v', 'w',
                        'surface_taux', 'surface_tauy', 'psi','forc_salt_surface','rho','prho','forc_rho_surface']
