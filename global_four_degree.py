...
class GlobalFourDegreeSetup(VerosSetup):
    ...
    #read your own surface salinity flux file into the model
    @veros_method
    def _read_forcing2(self, vs, var1):
        with h5netcdf.File('1020_4deg.averages.nc', 'r') as infile:
            var_obj2 = infile.variables[var1]
            return np.array(var_obj2, dtype=str(var_obj2.dtype)).T
    ...
    @veros_method(dist_safe=False, local_variables=[
        ...
        'forc_iw_bottom', 'forc_iw_surface','forc_salt_surface'
    ])
    ...
    def set_forcing(self, vs):
        ...
        # prescribed surface salinity forcing
        #vs.forc_salt_surface[2:-2, 2:-2] = self._read_forcing2(vs, 'forc_salt_surface')[:,:,-1] * vs.maskT[2:-2, 2:-2, -1]
    ...
    def set_diagnostics(self, vs):
        ...
        average_vars = ['temp', 'salt', 'u', 'v', 'w', 'surface_taux', 'surface_tauy', 'psi','forc_salt_surface','rho','prho','forc_rho_surface']
